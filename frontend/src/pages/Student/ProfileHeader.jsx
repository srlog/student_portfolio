...
const ProfileHeader = ({ profile, socialLinks, onEditProfile, onUpdatePassword }) => {
      ...
      <div className="relative flex flex-col lg:flex-row items-center gap-4">
        <div className="w-full lg:w-3/4 flex flex-col sm:flex-row items-center gap-8">
          <div className="relative group">
            <img
              src={profile.profile_picture || "/assets/images/avatar.jpg"}
              alt={profile.name}
        ...
        <div className="w-full lg:w-1/4 flex flex-col items-center justify-evenly gap-8">
          <button
            onClick={onEditProfile}
            className="flex items-center gap-4 bg-white/90 text-blue-900 font-bold py-4 px-8 rounded-full shadow transition transform hover:scale-110 hover:bg-white w-full"
          >
