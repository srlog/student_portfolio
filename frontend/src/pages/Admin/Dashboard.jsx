...
import adminAPI from "../../services/admin.api.service"; // adjust the API import as needed
...
const ConfirmPassword = ({ setIsOpen }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await adminAPI.updatePassword(updatedProfile);
...
function Dashboard() {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      const pendingAchievements = data.admin?.not_approved_achievements || 0;
      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
            ...
            <p className="text-4xl font-bold text-primary-500">
              {dashboardData.admin.achievements}
            </p>
          </div>
        </div>
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Reg No: {student.reg_no} | Year: {student.year} | Section:{" "}
                          {student.section}
                        </p>
                        <p className="text-sm text-gray-600">
